...
const server=http.createServer(async(req,res)=>{try{
  ...
  if(req.method==="GET"&&url.pathname==="/api/health")return sendJson(res,200,{ok:true,service:"openrabbit-prototype",gmailConfigured,openaiConfigured:Boolean(openAIProvider),providerToolCount:configuredProviderTools.length});
