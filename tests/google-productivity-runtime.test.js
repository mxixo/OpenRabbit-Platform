...
(()=>{
  ...
  const config=loadGoogleProductivityConfig({OPENRABBIT_ORG_ID:'org-1',GOOGLE_OAUTH_CLIENT_ID:'client',GOOGLE_OAUTH_CLIENT_SECRET:'secret',GOOGLE_OAUTH_REFRESH_TOKEN:'refresh',GOOGLE_GMAIL_USER_ID:'me',GOOGLE_CALENDAR_ID:'primary',OPENRABBIT_MAIL_SCAN_INTERVAL_MS:'60000',OPENRABBIT_MEETING_PROPOSAL_FILE:path.join(tmp,'proposals.json'),OPENAI_API_KEY:'test-openai-key'});
